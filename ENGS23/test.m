...
Theta1 = Theta1 - pi/2; % Put theta = 0 along vertical axis (y axis).
...
Theta4 = Theta4 - pi/2; % Put theta = 0 along vertical axis (y axis).
...
hold on
plot([0 0 -0.0025 0 0.0025]-Xshift1, [-0.005 0.005 0.0025 0.005 0.0025]-Yshift1, 'r', 'LineWidth',1.5)
plot([0 0 -0.0025 0 0.0025]-Xshift2, [-0.005 0.005 0.0025 0.005 0.0025]-Yshift2, 'r', 'LineWidth',1.5)
plot([0 0 -0.0025 0 0.0025]-Xshift3, [-0.005 0.005 0.0025 0.005 0.0025]-Yshift3, 'r', 'LineWidth',1.5)
plot([0 0 -0.0025 0 0.0025]-Xshift4, [-0.005 0.005 0.0025 0.005 0.0025]-Yshift4, 'r', 'LineWidth',1.5)
hold off
